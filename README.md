...
- [Main Components](#main-components)
  - [3.1. Voter Profiles](#31-voter-profiles)
  - [3.2. Reputation Assessments](#32-reputation-assessments)
    - [3.2.1. Adaptive Safeguards: The Equity Thermostat](#321-adaptive-safeguards-the-equity-thermostat)
  - [3.3. Vote Delegation](#33-vote-delegation)
  - [3.4. Bridging Strategies](#34-bridging-strategies)
  - [3.5. Verifications](#35-verifications)
  - [3.6. Connections](#36-connections)
  - [3.7. Decentralized Network](#37-decentralized-network)
  - [3.8. Participants](#38-participants)
  - [3.9. Incentives](#39-incentives)
  - [3.10. Governance and Meta-Governance](#310-governance-and-meta-governance)
    - [3.10.1. Governance Impact Statements](#3101-governance-impact-statements)
  - [3.11. [NEW] Accountability Lifecycle: Harm Index, Reversal, and Slashing](#311-new-accountability-lifecycle-harm-index-reversal-and-slashing)
- [Vote Weight and Reputation Dynamics](#vote-weight-and-reputation-dynamics)
- [Explicability and Transparency](#explicability-and-transparency)
- [Data Structures](#data-structures)
- [Protocol Sketch](#protocol-sketch)
- [Rewards for Nodes (Miners)](#rewards-for-nodes-miners)
- [Blockchain Technology](#blockchain-technology)
- [Protection Against Abuse and Manipulation](#protection-against-abuse-and-manipulation)
- [Applications](#applications)
- [Open Questions and Implementation Challenges](#open-questions-and-implementation-challenges)
...
- **Meta-Governance:** Decision-making about the protocol's rules, such as adjusting the Gini threshold or the B_velocity decay rate. These votes are weighted by Meta-Reputation.
...
- **Projected Impact Analysis:** How is this change expected to affect key system metrics (reputation gap, Gini, participation)?
- **Risk Assessment:** What are the worst-case scenarios and unintended consequences?
- **Mitigation Plan:** If risks are identified, what measures are proposed to mitigate them?

### 3.11. [NEW] Accountability Lifecycle: Harm Index, Reversal, and Slashing

To ensure that the protocol is not only adaptive but also self-correcting, it implements a formal accountability lifecycle. This process is triggered when a meta-governance decision is suspected of causing systemic harm.

**The Harm Index:** "Harm" is defined not by a single metric but by a composite Harm Index, calculated continuously. The index is a weighted score of key health indicators:

- **Inequality Component:** The current Gini coefficient of the thematic reputation distribution.
- **Gridlock Component:** The failure rate of "good" (non-malicious) meta-governance proposals over a rolling window.

The weights of these components (e.g., 70% Gini, 30% Gridlock) are themselves meta-governance parameters.

**The Reversal Vote:** If a meta-governance decision is implemented and the Harm Index subsequently crosses a critical, pre-defined Harm Threshold, a Reversal Vote is automatically triggered.

This is a simple majority vote (weighted by Meta-Reputation) to nullify the harmful rule change and revert the parameter to a safe, default state.

**Reputation Slashing and Shared Risk:** If the Reversal Vote passes, the accountability mechanism is activated:

- **Slashing:** The key participants who voted for the original harmful proposal will have a significant percentage of their Meta-Reputation permanently destroyed (slashed).
- **Shared Risk:** Participants who delegated their Meta-Reputation to a slashed participant will also lose a smaller percentage of their Meta-Reputation. This incentivizes careful delegation.

This entire lifecycle creates a systemic immune response, providing a strong disincentive against poorly conceived or malicious governance proposals and ensuring the long-term health of the protocol.
...
A participant's thematic reputation is moderated by the Adaptive Safeguards. Meta-Reputation is earned separately through constructive participation in meta-governance.

## Explicability and Transparency

Transparency without understanding is insufficient. The protocol must maintain a public explicability dashboard that translates raw data into comprehensible information. This dashboard will include:

- **Decision Narratives:** Natural language explanations for automated actions (e.g., "Inequality (Gini) has increased... the safety net (R_min) has been activated.").
- **Governance Impact Tracking:** A visual tracker showing the real-world impact of a rule change compared to the projections made in its Governance Impact Statement.

## Data Structures

(This section would be expanded in a technical paper to detail the on-chain structures for reputation, delegation with slashing risk, proposals with impact statements, and the historical data for the Harm Index.)

## Protocol Sketch

(This section would be expanded to describe the lifecycle of a meta-governance proposal, from submission with an impact statement, to voting, implementation, harm monitoring, and potential reversal with slashing.)
...
The primary defense against systemic bias is the integrated system of Adaptive Safeguards and Meta-Governance. The addition of a formal Accountability Lifecycle provides a strong disincentive against malicious or poorly conceived governance proposals.
...
- **Harm Index Calibration:** What are the optimal initial weights and thresholds for the Harm Index?
